...
$CAFFE/build/tools/extract_features.bin ./snapshots/run3_iter_40000.caffemodel ./quick_train_test.prototxt fc8_allFrames ./extracted/features2/ 155293 lmdb GPU 1