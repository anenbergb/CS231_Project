...
$CAFFE/build/tools/extract_features.bin ./snapshots/run2_from10k_iter_10000.caffemodel ./quick_train_test.prototxt fc8_allFrames ./extracted/features/ 7765 lmdb GPU 2