...
$CAFFE/build/tools/extract_features.bin ./snapshots/run1_from8k_iter_20000.caffemodel ./quick_train_test.prototxt fc8_allFrames ./extracted/features/ 7765 lmdb GPU 2