...
EXAMPLE=$PROJECT/examples/allFrames_finetune
DATA=$PROJECT/data/allFrames/lists
TOOLS=$CAFFE/build/tools

TRAIN_DATA_ROOT=../../data/allFrames/train/
TEST_DATA_ROOT=../../data/allFrames/train/
...
#    $TRAIN_DATA_ROOT \
#    $DATA/UCF_train_list.txt \
#    $EXAMPLE/lmdbs/train_lmdb_UCF
#
...
GLOG_logtostderr=1 $TOOLS/convert_imageset \
    ...
    --resize_width=$RESIZE_WIDTH \
    $TEST_DATA_ROOT \
    $DATA/UCF_test_list.txt \
    $EXAMPLE/lmdbs/test_lmdb_UCF
