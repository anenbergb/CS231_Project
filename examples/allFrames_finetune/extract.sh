...
$CAFFE/build/tools/extract_features.bin ./snapshots2/UCF_iter_40000.caffemodel ./model_UCF/quick_train_test.prototxt fc8_allFrames ./extracted/features_UCF/ 3755 lmdb GPU 2