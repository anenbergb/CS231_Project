...
$CAFFE/build/tools/extract_features.bin ./snapshots/run5_evenlr_iter_10000.caffemodel ./quick_train_test.prototxt fc8_allFrames ./extracted/features6/ 7724 lmdb GPU 2